 ...
 */
export interface EncodeHints extends Partial<Omit<ZXingEncodeHints, "format" | "characterSet" | "eccLevel">> {
    /**
...
export declare const defaultEncodeHints: Required<EncodeHints>;
export declare function encodeHintsToZXingEncodeHints<T extends "writer" | "full">(zxingModule: ZXingModule<T>, encodeHints: Required<EncodeHints>): ZXingEncodeHints;
