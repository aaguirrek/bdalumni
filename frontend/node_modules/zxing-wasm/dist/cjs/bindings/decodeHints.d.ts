 ...
 */
export interface DecodeHints extends Partial<Omit<ZXingDecodeHints, "formats" | "binarizer" | "eanAddOnSymbol" | "textMode" | "characterSet">> {
    /**
...
export declare const defaultDecodeHints: Required<DecodeHints>;
export declare function decodeHintsToZXingDecodeHints<T extends "reader" | "full">(zxingModule: ZXingModule<T>, decodeHints: Required<DecodeHints>): ZXingDecodeHints;
