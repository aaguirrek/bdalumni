...
var EMPTY_OBJ, EMPTY_ARR, NOOP2, NO2, onRE, isOn, isModelListener, extend2, remove, hasOwnProperty, hasOwn2, isArray2, isMap, isSet, isDate, isRegExp, isFunction, isString2, isSymbol, isObject2, isPromise, objectToString, toTypeString, toRawType2, isPlainObject, isIntegerKey, isReservedProp, isBuiltInDirective2, cacheStringFunction, camelizeRE, camelize, hyphenateRE, hyphenate2, capitalize2, toHandlerKey, hasChanged, invokeArrayFns, def, looseToNumber, toNumber, _globalThis, getGlobalThis, identRE, PatchFlagNames, slotFlagsText, GLOBALS_WHITE_LISTED, isGloballyWhitelisted, range, listDelimiterRE, propertyDelimiterRE, styleCommentRE, HTML_TAGS, SVG_TAGS, VOID_TAGS, isHTMLTag2, isSVGTag2, isVoidTag, specialBooleanAttrs, isSpecialBooleanAttr, isBooleanAttr, unsafeAttrCharRE, attrValidationCache, propsToAttrMap, isKnownHtmlAttr, isKnownSvgAttr, escapeRE, commentStripRE, toDisplayString, replacer;
var init_shared_esm_bundler = __esm({
  "node_modules/vue/node_modules/@vue/shared/dist/shared.esm-bundler.js"() {
    ...
    hasOwn2 = (val, key) => hasOwnProperty.call(val, key);
    ...
    hyphenateRE = /\B([A-Z])/g;
    hyphenate2 = cacheStringFunction(
      (str) => str.replace(hyphenateRE, "-$1").toLowerCase()
    );
    capitalize2 = cacheStringFunction(
...
function findDir(node, name, allowEmpty = false) {
  for (let i = 0; i < node.props.length; i++) {
    ...
    if (p.type === 7 && (allowEmpty || p.exp) && (isString2(name) ? p.name === name : name.test(p.name))) {
      return p;
    }
  }
}
...
function hasScopeRef(node, ids) {
  ...
  switch (node.type) {
    ...
    case 8:
      return node.children.some((c) => isObject2(c) && hasScopeRef(c, ids));
    case 5:
    case 12:
...
function createStructuralDirectiveTransform(name, fn) {
  const matches = isString2(name) ? (n) => n === name : (n) => name.test(n);
  return (node, context) => {
    if (node.type === 1) {
      const { props } = node;
...
function baseCompile(template, options = {}) {
  ...
  const ast = isString2(template) ? baseParse2(template, options) : template;
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
    ...
    isBuiltInType = (tag, expected) => tag === expected || tag === hyphenate2(expected);
    nonIdentifierRE = /^\d|[^\$\w]/;
    ...
    isSpecialTemplateDirective = makeMap2(
...
function parse(template, options = {}) {
  return baseParse2(template, extend2({}, parserOptions, options));
}
...
var require_vue_email_editor_common = __commonJS({
  "node_modules/vue-email-editor/dist/vue-email-editor.common.js"(exports, module) {
    (function() {
      var __webpack_modules__ = {
        ...
        9670: (
          /***/
          function(module2, __unused_webpack_exports, __webpack_require__2) {
            var isObject3 = __webpack_require__2(111);
            var $String = String;
            var $TypeError = TypeError;
            module2.exports = function(argument) {
        ...
        9920: (
          /***/
          function(module2, __unused_webpack_exports, __webpack_require__2) {
            var hasOwn3 = __webpack_require__2(2597);
        ...
        2597: (
          ...
          function(module2, __unused_webpack_exports, __webpack_require__2) {
            ...
            module2.exports = Object.hasOwn || function hasOwn3(it, key) {
        ...
        9191: (
          ...
          function(module2, __unused_webpack_exports, __webpack_require__2) {
            ...
            module2.exports = function(FULL_NAME, wrapper, FORCED, IS_AGGREGATE_ERROR) {
              ...
              if (!IS_PURE && hasOwn3(OriginalErrorPrototype, "cause"))
      ...
      !function() {
        ...
        __webpack_require__.d(runtime_dom_esm_bundler_namespaceObject, {
          ...
          "capitalize": function() {
            return shared_esm_bundler_capitalize;
          },
          "cloneVNode": function() {
            return cloneVNode;
          },
          ...
          "normalizeClass": function() {
            return normalizeClass2;
          },
          "normalizeProps": function() {
            return normalizeProps2;
          },
          "normalizeStyle": function() {
            return normalizeStyle2;
          },
          ...
          "toDisplayString": function() {
            return toDisplayString2;
          },
          "toHandlerKey": function() {
            return toHandlerKey2;
          },
          "toHandlers": function() {
            return toHandlers;
          },
          ...
          "warn": function() {
            return runtime_core_esm_bundler_warn;
          },
          "watch": function() {
            return watch;
          },
        ...
        const GLOBALS_WHITE_LISTED2 = "Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt";
        const isGloballyWhitelisted2 = shared_esm_bundler_makeMap(GLOBALS_WHITE_LISTED2);
        const range2 = 2;
        ...
        const specialBooleanAttrs2 = `itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly`;
        const isSpecialBooleanAttr2 = shared_esm_bundler_makeMap(specialBooleanAttrs2);
        const isBooleanAttr2 = shared_esm_bundler_makeMap(specialBooleanAttrs2 + `,async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected`);
        function includeBooleanAttr2(value) {
          return !!value || value === "";
        }
        const unsafeAttrCharRE2 = /[>/="'\u0009\u000a\u000c\u0020]/;
        const attrValidationCache2 = {};
        ...
        const isKnownHtmlAttr2 = (
          /* unused pure expression or super */
          null
        );
        const isKnownSvgAttr2 = (
          /* unused pure expression or super */
          null
        );
        function normalizeStyle2(value) {
          if (shared_esm_bundler_isArray(value)) {
            ...
            for (let i = 0; i < value.length; i++) {
              const item = value[i];
              const normalized = shared_esm_bundler_isString(item) ? parseStringStyle2(item) : normalizeStyle2(item);
              if (normalized) {
                for (const key in normalized) {
                  res[key] = normalized[key];
                }
        ...
        const HTML_TAGS2 = "html,body,base,head,link,meta,style,title,address,article,aside,footer,header,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot";
        const SVG_TAGS2 = "svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistanceLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view";
        const VOID_TAGS2 = "area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr";
        const shared_esm_bundler_isHTMLTag = shared_esm_bundler_makeMap(HTML_TAGS2);
        const shared_esm_bundler_isSVGTag = shared_esm_bundler_makeMap(SVG_TAGS2);
        const isVoidTag2 = shared_esm_bundler_makeMap(VOID_TAGS2);
        const escapeRE2 = /["'&<>]/;
        ...
        const commentStripRE2 = /^-?>|<!--|-->|--!>|<!-$/g;
        function escapeHtmlComment2(src2) {
          return src2.replace(commentStripRE2, "");
        }
        ...
        const toDisplayString2 = (val) => {
          return shared_esm_bundler_isString(val) ? val : val == null ? "" : shared_esm_bundler_isArray(val) || shared_esm_bundler_isObject(val) && (val.toString === objectToString2 || !isFunction2(val.toString)) ? JSON.stringify(val, replacer2, 2) : String(val);
        };
        const replacer2 = (_key, val) => {
          ...
          } else if (shared_esm_bundler_isObject(val) && !shared_esm_bundler_isArray(val) && !isPlainObject2(val)) {
            return String(val);
          }
          return val;
        };
        const EMPTY_OBJ2 = false ? 0 : {};
        const EMPTY_ARR2 = false ? 0 : [];
        const shared_esm_bundler_NOOP = () => {
        };
        const shared_esm_bundler_NO = () => false;
        const onRE2 = /^on[^a-z]/;
        const isOn2 = (key) => onRE2.test(key);
        const isModelListener2 = (key) => key.startsWith("onUpdate:");
        ...
        const isPromise2 = (val) => {
          return shared_esm_bundler_isObject(val) && isFunction2(val.then) && isFunction2(val.catch);
        };
        ...
        const isIntegerKey2 = (key) => shared_esm_bundler_isString(key) && key !== "NaN" && key[0] !== "-" && "" + parseInt(key, 10) === key;
        const isReservedProp2 = shared_esm_bundler_makeMap(
          // the leading comma is intentional so empty string "" is also included
          ",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"
        );
        const shared_esm_bundler_isBuiltInDirective = shared_esm_bundler_makeMap("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo");
        ...
        const shared_esm_bundler_hyphenate = cacheStringFunction2((str) => str.replace(hyphenateRE2, "-$1").toLowerCase());
        const shared_esm_bundler_capitalize = cacheStringFunction2((str) => str.charAt(0).toUpperCase() + str.slice(1));
        const toHandlerKey2 = cacheStringFunction2((str) => str ? `on${shared_esm_bundler_capitalize(str)}` : ``);
        const hasChanged2 = (value, oldValue) => !Object.is(value, oldValue);
        const invokeArrayFns2 = (fns, arg) => {
          for (let i = 0; i < fns.length; i++) {
            fns[i](arg);
          }
        };
        const def2 = (obj, key, value) => {
          Object.defineProperty(obj, key, {
            configurable: true,
            enumerable: false,
            value
        ...
        const getGlobalThis2 = () => {
          return _globalThis2 || (_globalThis2 = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : typeof __webpack_require__.g !== "undefined" ? __webpack_require__.g : {});
        };
        const identRE2 = /^[_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*$/;
        function genPropsAccessExp2(name) {
          return identRE2.test(name) ? `__props.${name}` : `__props[${JSON.stringify(name)}]`;
        }
        ;
        ...
        const builtInSymbols = new Set(Object.getOwnPropertyNames(Symbol).filter((key) => key !== "arguments" && key !== "caller").map((key) => Symbol[key]).filter(isSymbol2));
        ...
        function createGetter(isReadonly2 = false, shallow = false) {
          return function get2(target, key, receiver) {
            ...
            if (!isReadonly2 && targetIsArray && shared_esm_bundler_hasOwn(arrayInstrumentations, key)) {
        ...
        function createSetter(shallow = false) {
          return function set2(target, key, value, receiver) {
            ...
            const hadKey = shared_esm_bundler_isArray(target) && isIntegerKey2(key) ? Number(key) < target.length : shared_esm_bundler_hasOwn(target, key);
        ...
        function size(target, isReadonly2 = false) {
          ...
          !isReadonly2 && track(
            reactivity_esm_bundler_toRaw(target),
            "iterate",
            ITERATE_KEY
          );
        ...
        function getTargetType(value) {
          return value[
            "__v_skip"
            /* SKIP */
          ] || !Object.isExtensible(value) ? 0 : targetTypeMap(shared_esm_bundler_toRawType(value));
        }
        ...
        class ComputedRefImpl {
          ...
          get value() {
            const self2 = reactivity_esm_bundler_toRaw(this);
            trackRefValue(self2);
...
`], ...formatTraceEntry(entry));
        ...
        function flushPreFlushCbs(seen3, parentJob = null) {
          if (pendingPreFlushCbs.length) {
            ...
            flushPreFlushCbs(seen3, parentJob);
          }
        }
        ...
        function emit$1(instance, event, ...rawArgs) {
          ...
          if (!handler && isModelListener3) {
            handler = props[handlerName = toHandlerKey2(shared_esm_bundler_hyphenate(event))];
          }
          if (handler) {
        ...
        function renderComponentRoot(instance) {
          ...
          try {
            if (vnode.shapeFlag & 4) {
              ...
              result = normalizeVNode(render3.length > 1 ? render3(props, false ? 0 : {
                attrs,
                slots,
                emit: emit2
              }) : render3(
          ...
          if (fallthroughAttrs && inheritAttrs !== false) {
            ...
            if (keys.length) {
              if (shapeFlag & (1 | 6)) {
                if (propsOptions && keys.some(isModelListener2)) {
        ...
        const filterModelListeners = (attrs, props) => {
          const res = {};
          for (const key in attrs) {
            if (!isModelListener2(key) || !(key.slice(9) in props)) {
              res[key] = attrs[key];
            }
          }
          return res;
        ...
        function watchPostEffect(effect2, options) {
          return doWatch(effect2, null, false ? 0 : {
            flush: "post"
          });
        }
        ...
        function doWatch(source, cb, {
          ...
          if (isInSSRComponentSetup) {
            ...
            if (!cb) {
              ...
              callWithAsyncErrorHandling(
                ...
                instance,
                3,
                [getter(), isMultiSource ? [] : void 0, onCleanup]
              );
            }
          ...
          return () => {
            ...
            if (instance && instance.scope) {
              remove2(instance.scope.effects, effect2);
            }
          };
        }
        ...
        function traverse(value, seen3) {
          if (!shared_esm_bundler_isObject(value) || value[
            "__v_skip"
            /* SKIP */
          ]) {
            return value;
        ...
        function resolveAsset(type, name, warnMissing = true, maybeSelfReference = false) {
          ...
          if (instance) {
            ...
            if (type === COMPONENTS) {
              ...
              if (selfName && (selfName === name || selfName === camelize2(name) || selfName === shared_esm_bundler_capitalize(camelize2(name)))) {
                return Component;
              }
            }
            const res = (
        ...
        function resolve(registry, name) {
          return registry && (registry[name] || registry[camelize2(name)] || registry[shared_esm_bundler_capitalize(camelize2(name))]);
        }
        ...
        const PublicInstanceProxyHandlers = {
          get({
            ...
            if (key[0] !== "$") {
              ...
              if (n !== void 0) {
              ...
              } else if (setupState !== EMPTY_OBJ2 && shared_esm_bundler_hasOwn(setupState, key)) {
                accessCache[key] = 1;
                return setupState[key];
              } else if (data !== EMPTY_OBJ2 && shared_esm_bundler_hasOwn(data, key)) {
                accessCache[key] = 2;
                return data[key];
              } else if (
                ...
                accessCache[key] = 3;
                return props[key];
              } else if (ctx !== EMPTY_OBJ2 && shared_esm_bundler_hasOwn(ctx, key)) {
                accessCache[key] = 4;
                return ctx[key];
          ...
          set({
            ...
            if (setupState !== EMPTY_OBJ2 && shared_esm_bundler_hasOwn(setupState, key)) {
          ...
          has({
            ...
            let normalizedProps;
            return !!accessCache[key] || data !== EMPTY_OBJ2 && shared_esm_bundler_hasOwn(data, key) || setupState !== EMPTY_OBJ2 && shared_esm_bundler_hasOwn(setupState, key) || (normalizedProps = propsOptions[0]) && shared_esm_bundler_hasOwn(normalizedProps, key) || shared_esm_bundler_hasOwn(ctx, key) || shared_esm_bundler_hasOwn(publicPropertiesMap, key) || shared_esm_bundler_hasOwn(appContext.config.globalProperties, key);
          },
        ...
        function applyOptions(instance) {
          ...
          if (computedOptions) {
            for (const key in computedOptions) {
              ...
              const get2 = isFunction2(opt) ? opt.bind(publicThis, publicThis) : isFunction2(opt.get) ? opt.get.bind(publicThis, publicThis) : shared_esm_bundler_NOOP;
              if (false) {
              }
              const set2 = !isFunction2(opt) && isFunction2(opt.set) ? opt.set.bind(publicThis) : false ? 0 : shared_esm_bundler_NOOP;
          ...
          if (render2 && instance.render === shared_esm_bundler_NOOP) {
        ...
        function callHook(hook, instance, type) {
          callWithAsyncErrorHandling(shared_esm_bundler_isArray(hook) ? hook.map((h2) => h2.bind(instance.proxy)) : hook.bind(instance.proxy), instance, type);
        }
        ...
        function mergeDataFn(to, from) {
          ...
          return function mergedDataFn() {
            return shared_esm_bundler_extend(isFunction2(to) ? to.call(this, this) : to, isFunction2(from) ? from.call(this, this) : from);
          };
        }
        ...
        function mergeObjectOptions(to, from) {
          return to ? shared_esm_bundler_extend(shared_esm_bundler_extend(/* @__PURE__ */ Object.create(null), to), from) : from;
        }
        ...
        function setFullProps(instance, rawProps, props, attrs) {
          ...
          if (rawProps) {
            for (let key in rawProps) {
              ...
              const value = rawProps[key];
              let camelKey;
              if (options && shared_esm_bundler_hasOwn(options, camelKey = camelize2(key))) {
        ...
        function normalizePropsOptions(comp, appContext, asMixin = false) {
          ...
          if (shared_esm_bundler_isArray(raw)) {
            ...
            for (const key in raw) {
              ...
              if (validatePropName(normalizedKey)) {
                const opt = raw[key];
                const prop = normalized[normalizedKey] = shared_esm_bundler_isArray(opt) || isFunction2(opt) ? {
                  type: opt
                } : opt;
                if (prop) {
        ...
        function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
          ...
          if (isFunction2(ref2)) {
            ...
            const _isString = shared_esm_bundler_isString(ref2);
            ...
            if (_isString || _isRef) {
              const doSet = () => {
                if (rawRef.f) {
                  ...
                  if (isUnmount) {
                    shared_esm_bundler_isArray(existing) && remove2(existing, refValue);
                  } else {
                    if (!shared_esm_bundler_isArray(existing)) {
                      if (_isString) {
                        refs[ref2] = [refValue];
                        if (shared_esm_bundler_hasOwn(setupState, ref2)) {
              ...
              if (props) {
                if (forcePatchValue || !optimized || patchFlag & (16 | 32)) {
                  for (const key in props) {
                    if (forcePatchValue && key.endsWith("value") || isOn2(key) && !isReservedProp2(key)) {
        ...
        const normalizeRef = ({
          ...
          return ref2 != null ? shared_esm_bundler_isString(ref2) || isRef(ref2) || isFunction2(ref2) ? {
        ...
        function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
          ...
          const shapeFlag = shared_esm_bundler_isString(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : shared_esm_bundler_isObject(type) ? 4 : isFunction2(type) ? 2 : 0;
          if (false) {
          }
        ...
        function cloneVNode(vnode, extraProps, mergeRef = false) {
          ...
          const cloned = {
            ...
            ref: extraProps && extraProps.ref ? (
              ...
              mergeRef && ref2 ? shared_esm_bundler_isArray(ref2) ? ref2.concat(normalizeRef(extraProps)) : [ref2, normalizeRef(extraProps)] : normalizeRef(extraProps)
            ) : ref2,
        ...
        const runtime_core_esm_bundler_isRuntimeOnly = () => !compile2;
        ...
        function mergeDefaults(raw, defaults) {
          const props = shared_esm_bundler_isArray(raw) ? raw.reduce((normalized, p2) => (normalized[p2] = {}, normalized), {}) : raw;
          for (const key in defaults) {
            const opt = props[key];
            if (opt) {
              if (shared_esm_bundler_isArray(opt) || isFunction2(opt)) {
                props[key] = {
                  type: opt,
        ...
        const TransitionPropsValidators = Transition.props = shared_esm_bundler_extend({}, BaseTransition.props, DOMTransitionPropsValidators);
        ...
        function resolveTransitionProps(rawProps) {
          ...
          const makeEnterHook = (isAppear) => {
            return (el, done) => {
              ...
              runtime_dom_esm_bundler_callHook(hook, [el, resolve2]);
              nextFrame(() => {
          ...
          return shared_esm_bundler_extend(baseProps, {
            ...
            onLeave(el, done) {
              ...
              runtime_dom_esm_bundler_callHook(onLeave, [el, resolve2]);
            },
            onEnterCancelled(el) {
        ...
        const getModelAssigner = (vnode) => {
          ...
          return shared_esm_bundler_isArray(fn) ? (value) => invokeArrayFns2(fn, value) : fn;
        };
          ...
          created(el, _, vnode) {
            ...
            addEventListener(el, "change", () => {
              ...
              if (shared_esm_bundler_isArray(modelValue)) {
                const index = looseIndexOf2(modelValue, elementValue);
                const found = index !== -1;
                if (checked && !found) {
        ...
        function setChecked(el, {
          ...
          if (shared_esm_bundler_isArray(value)) {
            el.checked = looseIndexOf2(value, vnode.props.value) > -1;
          } else if (isSet2(value)) {
            el.checked = value.has(vnode.props.value);
          } else if (value !== oldValue) {
            el.checked = looseEqual2(value, getCheckboxValue(el, true));
          }
        }
        const vModelRadio = {
          created(el, {
        ...
        function setSelected(el, value) {
          ...
          if (isMultiple && !shared_esm_bundler_isArray(value) && !isSet2(value)) {
            return;
          }
          for (let i = 0, l = el.options.length; i < l; i++) {
            ...
            if (isMultiple) {
              if (shared_esm_bundler_isArray(value)) {
                option.selected = looseIndexOf2(value, optionValue) > -1;
              } else {
                option.selected = value.has(optionValue);
              }
            } else {
              if (looseEqual2(getValue(option), value)) {
        ...
        function initVModelForSSR() {
          ...
          vModelCheckbox.getSSRProps = ({
            ...
            if (shared_esm_bundler_isArray(value)) {
              if (vnode.props && looseIndexOf2(value, vnode.props.value) > -1) {
                return {
                  checked: true
                };
              }
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
        ...
        const FRAGMENT2 = Symbol(false ? 0 : ``);
        const TELEPORT2 = Symbol(false ? 0 : ``);
        const SUSPENSE2 = Symbol(false ? 0 : ``);
        const KEEP_ALIVE2 = Symbol(false ? 0 : ``);
        const BASE_TRANSITION2 = Symbol(false ? 0 : ``);
        const OPEN_BLOCK2 = Symbol(false ? 0 : ``);
        const CREATE_BLOCK2 = Symbol(false ? 0 : ``);
        const CREATE_ELEMENT_BLOCK2 = Symbol(false ? 0 : ``);
        const CREATE_VNODE2 = Symbol(false ? 0 : ``);
        const CREATE_ELEMENT_VNODE2 = Symbol(false ? 0 : ``);
        const CREATE_COMMENT2 = Symbol(false ? 0 : ``);
        const CREATE_TEXT2 = Symbol(false ? 0 : ``);
        const CREATE_STATIC2 = Symbol(false ? 0 : ``);
        const RESOLVE_COMPONENT2 = Symbol(false ? 0 : ``);
        const RESOLVE_DYNAMIC_COMPONENT2 = Symbol(false ? 0 : ``);
        const RESOLVE_DIRECTIVE2 = Symbol(false ? 0 : ``);
        const RESOLVE_FILTER2 = Symbol(false ? 0 : ``);
        const WITH_DIRECTIVES2 = Symbol(false ? 0 : ``);
        const RENDER_LIST2 = Symbol(false ? 0 : ``);
        const RENDER_SLOT2 = Symbol(false ? 0 : ``);
        const CREATE_SLOTS2 = Symbol(false ? 0 : ``);
        const TO_DISPLAY_STRING2 = Symbol(false ? 0 : ``);
        const MERGE_PROPS2 = Symbol(false ? 0 : ``);
        const NORMALIZE_CLASS2 = Symbol(false ? 0 : ``);
        const NORMALIZE_STYLE2 = Symbol(false ? 0 : ``);
        const NORMALIZE_PROPS2 = Symbol(false ? 0 : ``);
        const GUARD_REACTIVE_PROPS2 = Symbol(false ? 0 : ``);
        const TO_HANDLERS2 = Symbol(false ? 0 : ``);
        const CAMELIZE2 = Symbol(false ? 0 : ``);
        const CAPITALIZE2 = Symbol(false ? 0 : ``);
        const TO_HANDLER_KEY2 = Symbol(false ? 0 : ``);
        const SET_BLOCK_TRACKING2 = Symbol(false ? 0 : ``);
        const PUSH_SCOPE_ID2 = Symbol(false ? 0 : ``);
        const POP_SCOPE_ID2 = Symbol(false ? 0 : ``);
        const WITH_CTX2 = Symbol(false ? 0 : ``);
        const UNREF2 = Symbol(false ? 0 : ``);
        const IS_REF2 = Symbol(false ? 0 : ``);
        const WITH_MEMO2 = Symbol(false ? 0 : ``);
        const IS_MEMO_SAME2 = Symbol(false ? 0 : ``);
        const helperNameMap2 = {
          [FRAGMENT2]: `Fragment`,
          [TELEPORT2]: `Teleport`,
          [SUSPENSE2]: `Suspense`,
        ...
        function createVNodeCall2(context, tag, props, children, patchFlag, dynamicProps, directives, isBlock = false, disableTracking = false, isComponent3 = false, loc = locStub2) {
          if (context) {
            if (isBlock) {
        ...
        function createObjectProperty2(key, value) {
          return {
            type: 16,
            loc: locStub2,
            key: shared_esm_bundler_isString(key) ? createSimpleExpression2(key, true) : key,
            value
          };
        }
        ...
        function createInterpolation2(content, loc) {
          return {
            type: 5,
            loc,
            content: isString(content) ? createSimpleExpression2(content, false, loc) : content
          };
        }
        ...
        function createCacheExpression2(index, value, isVNode2 = false) {
          return {
            type: 20,
            index,
            value,
        ...
        const isStaticExp2 = (p2) => p2.type === 4 && p2.isStatic;
        const isBuiltInType2 = (tag, expected) => tag === expected || tag === shared_esm_bundler_hyphenate(expected);
        function isCoreComponent2(tag) {
          if (isBuiltInType2(tag, "Teleport")) {
            return TELEPORT2;
          } else if (isBuiltInType2(tag, "Suspense")) {
            return SUSPENSE2;
          } else if (isBuiltInType2(tag, "KeepAlive")) {
            return KEEP_ALIVE2;
          } else if (isBuiltInType2(tag, "BaseTransition")) {
            return BASE_TRANSITION2;
          }
        }
        const nonIdentifierRE2 = /^\d|[^\$\w]/;
        const isSimpleIdentifier2 = (name) => !nonIdentifierRE2.test(name);
        const validFirstIdentCharRE2 = /[A-Za-z_$\xA0-\uFFFF]/;
        const validIdentCharRE2 = /[\.\?\w$\xA0-\uFFFF]/;
        const whitespaceRE2 = /\s+[.[]\s*|\s*[.[]\s+/g;
        const isMemberExpressionBrowser2 = (path) => {
          path = path.trim().replace(whitespaceRE2, (s) => s.trim());
          let state = 0;
          let stateStack = [];
          let currentOpenBracketCount = 0;
          let currentOpenParensCount = 0;
        ...
        const isMemberExpressionNode2 = (
          /* unused pure expression or super */
          null
        );
        const isMemberExpression2 = isMemberExpressionBrowser2;
        function getInnerRange2(loc, offset, length) {
          const source = loc.source.slice(offset, offset + length);
          const newLoc = {
            source,
          ...
          if (length != null) {
            newLoc.end = advancePositionWithClone2(loc.start, loc.source, offset + length);
          }
          return newLoc;
        }
        function advancePositionWithClone2(pos, source, numberOfCharacters = source.length) {
          return advancePositionWithMutation2(shared_esm_bundler_extend({}, pos), source, numberOfCharacters);
        }
        ...
        function findDir2(node, name, allowEmpty = false) {
          for (let i = 0; i < node.props.length; i++) {
            ...
            if (p2.type === 7 && (allowEmpty || p2.exp) && (shared_esm_bundler_isString(name) ? p2.name === name : name.test(p2.name))) {
              return p2;
            }
          }
        }
        function findProp2(node, name, dynamicOnly = false, allowEmpty = false) {
          for (let i = 0; i < node.props.length; i++) {
            ...
            } else if (p2.name === "bind" && (p2.exp || allowEmpty) && isStaticArgOf2(p2.arg, name)) {
              return p2;
            }
          }
        }
        ...
        function isVSlot2(p2) {
          return p2.type === 7 && p2.name === "slot";
        }
        function isTemplateNode2(node) {
          return node.type === 1 && node.tagType === 3;
        }
        function isSlotOutlet2(node) {
          return node.type === 1 && node.tagType === 2;
        }
        ...
        const propsHelperSet2 = /* @__PURE__ */ new Set([NORMALIZE_PROPS2, GUARD_REACTIVE_PROPS2]);
        function getUnnormalizedProps2(props, callPath = []) {
          if (props && !shared_esm_bundler_isString(props) && props.type === 14) {
            const callee = props.callee;
            if (!shared_esm_bundler_isString(callee) && propsHelperSet2.has(callee)) {
              return getUnnormalizedProps2(props.arguments[0], callPath.concat(props));
            }
          }
          return [props, callPath];
        }
        function injectProp2(node, prop, context) {
          let propsWithInjection;
          let props = node.type === 13 ? node.props : node.arguments[2];
          let callPath = [];
          let parentCall;
          ...
          if (props == null || shared_esm_bundler_isString(props)) {
            ...
            if (!shared_esm_bundler_isString(first) && first.type === 15) {
              ...
              if (props.callee === TO_HANDLERS2) {
                propsWithInjection = createCallExpression2(context.helper(MERGE_PROPS2), [createObjectExpression2([prop]), props]);
              } else {
        ...
        function hasScopeRef2(node, ids) {
          if (!node || Object.keys(ids).length === 0) {
            return false;
          }
          switch (node.type) {
            case 1:
              for (let i = 0; i < node.props.length; i++) {
                const p2 = node.props[i];
                if (p2.type === 7 && (hasScopeRef2(p2.arg, ids) || hasScopeRef2(p2.exp, ids))) {
                  return true;
                }
              }
              return node.children.some((c) => hasScopeRef2(c, ids));
            case 11:
              if (hasScopeRef2(node.source, ids)) {
                return true;
              }
              return node.children.some((c) => hasScopeRef2(c, ids));
            case 9:
              return node.branches.some((b) => hasScopeRef2(b, ids));
            case 10:
              if (hasScopeRef2(node.condition, ids)) {
                return true;
              }
              return node.children.some((c) => hasScopeRef2(c, ids));
            case 4:
              return !node.isStatic && isSimpleIdentifier2(node.content) && !!ids[node.content];
            case 8:
              return node.children.some((c) => isObject(c) && hasScopeRef2(c, ids));
            case 5:
            case 12:
              return hasScopeRef2(node.content, ids);
            case 2:
            case 3:
              return false;
            default:
        ...
        function getMemoedVNodeCall2(node) {
          if (node.type === 14 && node.callee === WITH_MEMO2) {
            return node.arguments[1].returns;
          } else {
            return node;
          }
        ...
        function makeBlock(node, {
          ...
          if (!node.isBlock) {
            node.isBlock = true;
            removeHelper(getVNodeHelper2(inSSR, node.isComponent));
            helper(OPEN_BLOCK2);
            helper(getVNodeBlockHelper2(inSSR, node.isComponent));
          }
        }
        const deprecationData2 = {
          [
            "COMPILER_IS_ON_ELEMENT"
            /* COMPILER_IS_ON_ELEMENT */
          ]: {
  ...
  Details: ${link}` : ``}`;
        ...
        const decodeRE2 = /&(gt|lt|amp|apos|quot);/g;
        const decodeMap2 = {
          gt: ">",
          lt: "<",
          amp: "&",
        ...
        function compiler_core_esm_bundler_baseParse(content, options = {}) {
          ...
          return createRoot2(parseChildren2(
            context,
            0,
            []
          ), getSelection2(context, start));
        }
        function createParserContext2(content, rawOptions) {
          const options = shared_esm_bundler_extend({}, defaultParserOptions2);
          let key;
          for (key in rawOptions) {
          ...
          while (!isEnd2(context, mode, ancestors)) {
            ...
            if (mode === 0 || mode === 1) {
              if (!context.inVPre && startsWith2(s, context.options.delimiters[0])) {
                node = parseInterpolation2(context, mode);
              } else if (mode === 0 && s[0] === "<") {
                if (s.length === 1) {
                  emitError2(
                    context,
                  ...
                  if (startsWith2(s, "<!--")) {
                    node = parseComment2(context);
                  } else if (startsWith2(s, "<!DOCTYPE")) {
                    node = parseBogusComment2(context);
                  } else if (startsWith2(s, "<![CDATA[")) {
                    if (ns !== 0) {
                      node = parseCDATA2(context, ancestors);
                    } else {
                      emitError2(
                        context,
                        1
                  ...
                  node = parseElement2(context, ancestors);
                  if (isCompatEnabled2(
                    "COMPILER_NATIVE_TEMPLATE",
                    context
                  ) && node && node.tag === "template" && !node.props.some((p2) => p2.type === 7 && isSpecialTemplateDirective2(p2.name))) {
                    node = node.children;
                  }
                } else if (s[1] === "?") {
                  emitError2(
            ...
            if (!node) {
              node = parseText2(context, mode);
            }
            if (shared_esm_bundler_isArray(node)) {
              for (let i = 0; i < node.length; i++) {
                pushNode2(nodes, node[i]);
              }
            } else {
              pushNode2(nodes, node);
            }
          }
          let removedWhitespace = false;
          if (mode !== 2 && mode !== 1) {
        ...
        const isSpecialTemplateDirective2 = shared_esm_bundler_makeMap(`if,else,else-if,for,slot`);
        function parseTag2(context, type, parent) {
          ...
          if (type === 0 && !context.inVPre && props.some((p2) => p2.type === 7 && p2.name === "pre")) {
            ...
            context.source = currentSource;
            props = parseAttributes2(context, type).filter((p2) => p2.name !== "v-pre");
          }
          let isSelfClosing = false;
          if (context.source.length === 0) {
            emitError2(
          ...
          if (!context.inVPre) {
            if (tag === "slot") {
              ...
              if (props.some((p2) => p2.type === 7 && isSpecialTemplateDirective2(p2.name))) {
                tagType = 3;
              }
            } else if (isComponent2(tag, props, context)) {
              tagType = 1;
            }
          }
          return {
        ...
        function isComponent2(tag, props, context) {
          const options = context.options;
          if (options.isCustomElement(tag)) {
            return false;
          }
          if (tag === "component" || /^[A-Z]/.test(tag) || isCoreComponent2(tag) || options.isBuiltInComponent && options.isBuiltInComponent(tag) || options.isNativeTag && !options.isNativeTag(tag)) {
            return true;
          }
          for (let i = 0; i < props.length; i++) {
            const p2 = props[i];
            if (p2.type === 6) {
              ...
              if (p2.name === "is") {
                ...
                // :is on plain element - only treat as component in compat mode
                p2.name === "bind" && isStaticArgOf2(p2.arg, "is") && true && checkCompatEnabled2(
                  "COMPILER_IS_ON_ELEMENT",
                  context,
                  p2.loc
                )
        ...
        function parseAttribute2(context, nameSet) {
          ...
          if (!context.inVPre && /^(v-[A-Za-z0-9-]|:|\.|@|#)/.test(name)) {
            ...
            if (isPropShorthand)
              modifiers.push("prop");
            if (dirName === "bind" && arg) {
              if (modifiers.includes("sync") && checkCompatEnabled2(
                "COMPILER_V_BIND_SYNC",
                context,
                loc,
                arg.loc.source
        ...
        function parseTextData2(context, length, mode) {
          const rawText = context.source.slice(0, length);
          advanceBy2(context, length);
          if (mode === 2 || mode === 3 || !rawText.includes("&")) {
            return rawText;
          } else {
            return context.options.decodeEntities(
        ...
        function startsWithEndTagOpen2(source, tag) {
          return startsWith2(source, "</") && source.slice(2, 2 + tag.length).toLowerCase() === tag.toLowerCase() && /[\t\r\n\f />]/.test(source[2 + tag.length] || ">");
        }
        function hoistStatic2(root, context) {
          walk2(
            root,
            context,
            // Root node is unfortunately non-hoistable due to potential parent
            // fallthrough attributes.
            isSingleElementRoot2(root, root.children[0])
          );
        }
        function isSingleElementRoot2(root, child) {
          const {
            children
          } = root;
        ...
        function walk2(node, context, doNotHoistNode = false) {
          ...
          if (hoistedCount && hoistedCount === originalCount && node.type === 1 && node.tagType === 0 && node.codegenNode && node.codegenNode.type === 13 && shared_esm_bundler_isArray(node.codegenNode.children)) {
            node.codegenNode.children = context.hoist(createArrayExpression2(node.codegenNode.children));
          }
        }
        function getConstantType2(node, context) {
          ...
          switch (node.type) {
            case 1:
              ...
              if (!flag) {
                let returnType2 = 3;
                const generatedPropsType = getGeneratedPropsConstantType2(node, context);
                if (generatedPropsType === 0) {
                  constantCache.set(
                    node,
                    0
                ...
                if (returnType2 > 1) {
                  for (let i = 0; i < node.props.length; i++) {
                    ...
                    if (p2.type === 7 && p2.name === "bind" && p2.exp) {
                      const expType = getConstantType2(p2.exp, context);
                      if (expType === 0) {
                        constantCache.set(
                          node,
                          0
            ...
            case 8:
              ...
              for (let i = 0; i < node.children.length; i++) {
                const child = node.children[i];
                if (shared_esm_bundler_isString(child) || isSymbol2(child)) {
                  continue;
                }
        ...
        const allowHoistedHelperSet2 = /* @__PURE__ */ new Set([NORMALIZE_CLASS2, NORMALIZE_STYLE2, NORMALIZE_PROPS2, GUARD_REACTIVE_PROPS2]);
        function getConstantTypeOfHelperCall2(value, context) {
          if (value.type === 14 && !shared_esm_bundler_isString(value.callee) && allowHoistedHelperSet2.has(value.callee)) {
            const arg = value.arguments[0];
            if (arg.type === 4) {
        ...
        function getGeneratedPropsConstantType2(node, context) {
          let returnType = 3;
          const props = getNodeProps2(node);
          if (props && props.type === 15) {
            const {
              properties
            } = props;
        ...
        function getNodeProps2(node) {
          const codegenNode = node.codegenNode;
          if (codegenNode.type === 13) {
            return codegenNode.props;
          }
        }
        function getPatchFlag2(node) {
          const flag = node.patchFlag;
          return flag ? parseInt(flag, 10) : void 0;
        }
        function createTransformContext2(root, {
          filename = "",
          prefixIdentifiers = false,
          hoistStatic: hoistStatic3 = false,
          cacheHandlers = false,
          nodeTransforms = [],
          directiveTransforms = {},
          transformHoist = null,
          ...
          const context = {
            // options
            selfName: nameMatch && shared_esm_bundler_capitalize(camelize2(nameMatch[1])),
            prefixIdentifiers,
            ...
            cache(exp, isVNode2 = false) {
              return createCacheExpression2(context.cached++, exp, isVNode2);
            }
          };
          {
            context.filters = /* @__PURE__ */ new Set();
        ...
        function transform2(root, options) {
          const context = createTransformContext2(root, options);
          traverseNode2(root, context);
          if (options.hoistStatic) {
            hoistStatic2(root, context);
          }
          if (!options.ssr) {
            createRootCodegen2(root, context);
          }
        ...
        function createRootCodegen2(root, context) {
          const {
            helper
          } = context;
          const {
          ...
          if (children.length === 1) {
            const child = children[0];
            if (isSingleElementRoot2(root, child) && child.codegenNode) {
              const codegenNode = child.codegenNode;
              if (codegenNode.type === 13) {
            ...
            let patchFlag = 64;
            let patchFlagText = PatchFlagNames2[64];
            if (false) {
            }
            root.codegenNode = createVNodeCall2(
              context,
              helper(FRAGMENT2),
              void 0,
              root.children,
        ...
        function traverseNode2(node, context) {
          ...
          switch (node.type) {
            ...
            case 1:
            case 0:
              traverseChildren2(node, context);
              break;
          }
          context.currentNode = node;
          let i = exitFns.length;
        ...
        function createStructuralDirectiveTransform2(name, fn) {
          const matches2 = shared_esm_bundler_isString(name) ? (n) => n === name : (n) => name.test(n);
          return (node, context) => {
            if (node.type === 1) {
              const {
                props
              } = node;
              if (node.tagType === 3 && props.some(isVSlot2)) {
                return;
              }
              const exitFns = [];
              for (let i = 0; i < props.length; i++) {
        ...
        const PURE_ANNOTATION2 = `/*#__PURE__*/`;
        const aliasHelper2 = (s) => `${helperNameMap2[s]}: _${helperNameMap2[s]}`;
        function createCodegenContext2(ast, {
          mode = "function",
          prefixIdentifiers = mode === "module",
          sourceMap = false,
          filename = `template.vue.html`,
        ...
        function generate2(ast, options = {}) {
          ...
          if (useWithBlock) {
            ...
            indent();
            if (hasHelpers) {
              push(`const { ${ast.helpers.map(aliasHelper2).join(", ")} } = _Vue`);
              push(`
`);
              newline();
            }
...
`);
              if (ast.hoists.length) {
                const staticHelpers = [CREATE_VNODE2, CREATE_ELEMENT_VNODE2, CREATE_COMMENT2, CREATE_TEXT2, CREATE_STATIC2].filter((helper) => ast.helpers.includes(helper)).map(aliasHelper2).join(", ");
                push(`const { ${staticHelpers} } = _Vue
`);
              }
            }
        ...
        function genAssets2(assets, type, {
          helper,
          push,
          newline,
          isTS
          ...
          for (let i = 0; i < assets.length; i++) {
            ...
            push(`const ${toValidAssetId2(id, type)} = ${resolver}(${JSON.stringify(id)}${maybeSelfReference ? `, true` : ``})${isTS ? `!` : ``}`);
            if (i < assets.length - 1) {
              newline();
            }
          }
        ...
        function genNodeList2(nodes, context, multilines = false, comma = true) {
          ...
          for (let i = 0; i < nodes.length; i++) {
            ...
            if (shared_esm_bundler_isString(node)) {
              ...
              genNodeListAsArray2(node, context);
            } else {
              genNode2(node, context);
            }
            if (i < nodes.length - 1) {
              if (multilines) {
                comma && push(",");
        ...
        function genNode2(node, context) {
          if (shared_esm_bundler_isString(node)) {
            context.push(node);
            return;
          }
          ...
          switch (node.type) {
            ...
            case 9:
            case 11:
              genNode2(node.codegenNode, context);
              break;
            case 2:
              genText2(node, context);
              break;
            case 4:
              genExpression2(node, context);
              break;
            case 5:
              genInterpolation2(node, context);
              break;
            case 12:
              genNode2(node.codegenNode, context);
              break;
            case 8:
              genCompoundExpression2(node, context);
              break;
            case 3:
              genComment2(node, context);
              break;
            case 13:
              genVNodeCall2(node, context);
              break;
            case 14:
              genCallExpression2(node, context);
              break;
            case 15:
              genObjectExpression2(node, context);
              break;
            case 17:
              genArrayExpression2(node, context);
              break;
            case 18:
              genFunctionExpression2(node, context);
              break;
            case 19:
              genConditionalExpression2(node, context);
              break;
            case 20:
              genCacheExpression2(node, context);
              break;
            case 21:
              genNodeList2(node.body, context, true, false);
              break;
            case 22:
              break;
            case 23:
        ...
        function genText2(node, context) {
          context.push(JSON.stringify(node.content), node);
        }
        function genExpression2(node, context) {
          const {
            content,
            isStatic
          } = node;
        ...
        function genInterpolation2(node, context) {
          const {
            push,
            helper,
            pure
          ...
          genNode2(node.content, context);
          push(`)`);
        }
        function genCompoundExpression2(node, context) {
          for (let i = 0; i < node.children.length; i++) {
            const child = node.children[i];
            if (shared_esm_bundler_isString(child)) {
              context.push(child);
        ...
        function genExpressionAsPropertyKey2(node, context) {
          const {
            push
          } = context;
          if (node.type === 8) {
            ...
            const text = isSimpleIdentifier2(node.content) ? node.content : JSON.stringify(node.content);
            push(text, node);
          } else {
            push(`[${node.content}]`, node);
          }
        }
        function genComment2(node, context) {
          const {
            push,
            helper,
            pure
          ...
          push(`${helper(CREATE_COMMENT2)}(${JSON.stringify(node.content)})`, node);
        }
        function genVNodeCall2(node, context) {
          const {
            push,
            helper,
            pure
          ...
          push(helper(callHelper) + `(`, node);
          genNodeList2(genNullableArgs2([tag, props, children, patchFlag, dynamicProps]), context);
          push(`)`);
          if (isBlock) {
            push(`)`);
          }
        ...
        function genCallExpression2(node, context) {
          const {
            push,
            helper,
            pure
          ...
          push(callee + `(`, node);
          genNodeList2(node.arguments, context);
          push(`)`);
        }
        function genObjectExpression2(node, context) {
          const {
            push,
            indent,
            deindent,
        ...
        function genArrayExpression2(node, context) {
          genNodeListAsArray2(node.elements, context);
        }
        function genFunctionExpression2(node, context) {
          const {
            push,
            indent,
            deindent
        ...
        function genConditionalExpression2(node, context) {
          const {
            test,
            consequent,
            alternate,
        ...
        function genCacheExpression2(node, context) {
          const {
            push,
            helper,
            indent,
        ...
        function walkIdentifiers2(root, onIdentifier, includeAll = false, parentStack = [], knownIds = /* @__PURE__ */ Object.create(null)) {
          {
            return;
          }
        }
        function isReferencedIdentifier2(id, parent, parentStack) {
          {
            return false;
          }
        }
        ...
        function walkFunctionParams2(node, onIdent) {
          for (const p2 of node.params) {
            for (const id of extractIdentifiers2(p2)) {
              onIdent(id);
            }
          }
        }
          ...
          for (const stmt of block.body) {
            if (stmt.type === "VariableDeclaration") {
              if (stmt.declare)
                continue;
              for (const decl of stmt.declarations) {
                for (const id of extractIdentifiers2(decl.id)) {
                  onIdent(id);
                }
              }
            } else if (stmt.type === "FunctionDeclaration" || stmt.type === "ClassDeclaration") {
        ...
        const isFunctionType2 = (node) => {
          return /Function(?:Expression|Declaration)$|Method$/.test(node.type);
        };
        const isStaticProperty2 = (node) => node && (node.type === "ObjectProperty" || node.type === "ObjectMethod") && !node.computed;
        const isStaticPropertyKey2 = (node, parent) => isStaticProperty2(parent) && parent.key === node;
        const prohibitedKeywordRE2 = new RegExp("\\b" + "do,if,for,let,new,try,var,case,else,with,await,break,catch,class,const,super,throw,while,yield,delete,export,import,return,switch,default,extends,finally,continue,debugger,function,arguments,typeof,void".split(",").join("\\b|\\b") + "\\b");
        const stripStringRE2 = /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g;
        function validateBrowserExpression2(node, context, asParams = false, asRawStatements = false) {
          const exp = node.content;
          if (!exp.trim()) {
            return;
          }
          try {
            ...
            context.onError(createCompilerError2(
              44,
              node.loc,
              void 0,
              message
        ...
        const transformExpression2 = (node, context) => {
          if (node.type === 5) {
            node.content = processExpression2(node.content, context);
          } else if (node.type === 1) {
            for (let i = 0; i < node.props.length; i++) {
              const dir = node.props[i];
              if (dir.type === 7 && dir.name !== "for") {
        ...
        function processExpression2(node, context, asParams = false, asRawStatements = false, localVars = Object.create(context.identifiers)) {
          {
            if (false) {
            }
            return node;
        ...
        const transformIf2 = createStructuralDirectiveTransform2(/^(if|else|else-if)$/, (node, dir, context) => {
          return processIf2(node, dir, context, (ifNode, branch, isRoot) => {
            const siblings = context.parent.children;
            let i = siblings.indexOf(ifNode);
            let key = 0;
            while (i-- >= 0) {
        ...
        function processIf2(node, dir, context, processCodegen) {
          if (dir.name !== "else" && (!dir.exp || !dir.exp.content.trim())) {
            const loc = dir.exp ? dir.exp.loc : node.loc;
            context.onError(createCompilerError2(
              28,
          ...
          if (dir.name === "if") {
            const branch = createIfBranch2(node, dir);
            const ifNode = {
              type: 9,
              loc: node.loc,
              branches: [branch]
        ...
        function createIfBranch2(node, dir) {
          const isTemplateIf = node.tagType === 3;
          return {
            type: 10,
            loc: node.loc,
        ...
        function createCodegenNodeForBranch2(branch, keyIndex, context) {
          if (branch.condition) {
            return createConditionalExpression2(
              branch.condition,
              createChildrenCodegenNode2(branch, keyIndex, context),
              // make sure to pass in asBlock: true so that the comment node call
              // closes the current block.
              createCallExpression2(context.helper(CREATE_COMMENT2), [false ? 0 : '""', "true"])
            );
          } else {
        ...
        function createChildrenCodegenNode2(branch, keyIndex, context) {
          ...
          const keyProperty = createObjectProperty2(`key`, createSimpleExpression2(
            `${keyIndex}`,
            false,
            locStub2,
            2
          ...
          if (needFragmentWrapper) {
            if (children.length === 1 && firstChild.type === 11) {
              ...
              return createVNodeCall2(
                context,
                helper(FRAGMENT2),
                createObjectExpression2([keyProperty]),
                children,
                patchFlag + (false ? 0 : ``),
                void 0,
                void 0,
        ...
        function getParentCondition2(node) {
          while (true) {
            if (node.type === 19) {
              if (node.alternate.type === 19) {
                node = node.alternate;
        ...
        const transformFor2 = createStructuralDirectiveTransform2("for", (node, dir, context) => {
          const {
            helper,
            removeHelper
          } = context;
          return processFor2(node, dir, context, (forNode) => {
            const renderExp = createCallExpression2(helper(RENDER_LIST2), [forNode.source]);
            const isTemplate = isTemplateNode2(node);
            const memo = findDir2(node, "memo");
            const keyProp = findProp2(node, `key`);
            ...
            const isStableFragment = forNode.source.type === 4 && forNode.source.constType > 0;
            const fragmentFlag = isStableFragment ? 64 : keyProp ? 128 : 256;
            forNode.codegenNode = createVNodeCall2(
              context,
              helper(FRAGMENT2),
              void 0,
              renderExp,
            ...
            return () => {
              ...
              const needFragmentWrapper = children.length !== 1 || children[0].type !== 1;
              const slotOutlet = isSlotOutlet2(node) ? node : isTemplate && node.children.length === 1 && isSlotOutlet2(node.children[0]) ? node.children[0] : null;
              if (slotOutlet) {
                childBlock = slotOutlet.codegenNode;
                if (isTemplate && keyProperty) {
                ...
                childBlock = createVNodeCall2(
                  context,
                  helper(FRAGMENT2),
                  keyProperty ? createObjectExpression2([keyProperty]) : void 0,
                  node.children,
                  64 + (false ? 0 : ``),
                  void 0,
                  void 0,
              ...
              if (memo) {
                const loop = createFunctionExpression2(createForLoopParams2(forNode.parseResult, [createSimpleExpression2(`_cached`)]));
                loop.body = createBlockStatement2([createCompoundExpression2([`const _memo = (`, memo.exp, `)`]), createCompoundExpression2([`if (_cached`, ...keyExp ? [` && _cached.key === `, keyExp] : [], ` && ${context.helperString(IS_MEMO_SAME2)}(_cached, _memo)) return _cached`]), createCompoundExpression2([`const _item = `, childBlock]), createSimpleExpression2(`_item.memo = _memo`), createSimpleExpression2(`return _item`)]);
                renderExp.arguments.push(loop, createSimpleExpression2(`_cache`), createSimpleExpression2(String(context.cached++)));
              } else {
                renderExp.arguments.push(createFunctionExpression2(
                  createForLoopParams2(forNode.parseResult),
                  childBlock,
                  true
                  /* force newline */
                ));
        ...
        function processFor2(node, dir, context, processCodegen) {
          if (!dir.exp) {
            context.onError(createCompilerError2(
              31,
              dir.loc
          ...
          const parseResult = parseForExpression2(
            // can only be simple expression because vFor transform is applied
            // before expression transform.
            dir.exp,
            context
          ...
          const forNode = {
            ...
            objectIndexAlias: index,
            parseResult,
            children: isTemplateNode2(node) ? node.children : [node]
          };
          context.replaceNode(forNode);
          scopes.vFor++;
          const onExit = processCodegen && processCodegen(forNode);
        ...
        const forAliasRE2 = /([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/;
        const forIteratorRE2 = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/;
        const stripParensRE2 = /^\(|\)$/g;
        function parseForExpression2(input, context) {
          const loc = input.loc;
          const exp = input.content;
          ...
          if (iteratorMatch) {
            ...
            if (keyContent) {
              keyOffset = exp.indexOf(keyContent, trimmedOffset + valueContent.length);
              result.key = createAliasExpression2(loc, keyContent, keyOffset);
              if (false) {
              }
            }
            if (iteratorMatch[2]) {
              const indexContent = iteratorMatch[2].trim();
              if (indexContent) {
                result.index = createAliasExpression2(loc, indexContent, exp.indexOf(indexContent, result.key ? keyOffset + keyContent.length : trimmedOffset + valueContent.length));
                if (false) {
                }
              }
            }
          ...
          if (valueContent) {
            result.value = createAliasExpression2(loc, valueContent, trimmedOffset);
            if (false) {
            }
          }
          return result;
        }
        function createAliasExpression2(range3, content, offset) {
          return createSimpleExpression2(content, false, getInnerRange2(range3, offset, content.length));
        }
        function createForLoopParams2({
          value,
          key,
          index
        }, memoArgs = []) {
        ...
        const defaultFallback2 = createSimpleExpression2(`undefined`, false);
        const trackSlotScopes2 = (node, context) => {
          if (node.type === 1 && (node.tagType === 1 || node.tagType === 3)) {
        ...
        const trackVForSlotScopes2 = (node, context) => {
          let vFor;
          if (isTemplateNode2(node) && node.props.some(isVSlot2) && (vFor = findDir2(node, "for"))) {
            const result = vFor.parseResult = parseForExpression2(vFor.exp, context);
            if (result) {
              const {
                value,
                key,
        ...
        const buildClientSlotFn2 = (props, children, loc) => createFunctionExpression2(
          props,
          children,
          false,
          true,
        ...
        function buildSlots2(node, context, buildSlotFn = buildClientSlotFn2) {
          ...
          for (let i = 0; i < children.length; i++) {
            ...
            if (vIf = findDir2(slotElement, "if")) {
              ...
              if (parseResult) {
                dynamicSlots.push(createCallExpression2(context.helper(RENDER_LIST2), [parseResult.source, createFunctionExpression2(
                  createForLoopParams2(parseResult),
                  buildDynamicSlot2(slotName, slotFunction),
                  true
                  /* force newline */
                )]));
              } else {
          ...
          if (!onComponentSlot) {
            ...
            // with whitespace: 'preserve', whitespaces between slots will end up in
            // implicitDefaultChildren. Ignore if all implicit children are whitespaces.
            implicitDefaultChildren.some((node2) => isNonWhitespaceContent2(node2))) {
              if (hasNamedDefaultSlot) {
                context.onError(createCompilerError2(
                  39,
                  implicitDefaultChildren[0].loc
          ...
          const slotFlag = hasDynamicSlots ? 2 : hasForwardedSlots2(node.children) ? 3 : 1;
          let slots = createObjectExpression2(slotsProperties.concat(createObjectProperty2(
            `_`,
            // 2 = compiled but dynamic = can skip normalization, but must run diff
            // 1 = compiled and static = can skip normalization AND diff as optimized
            createSimpleExpression2(slotFlag + (false ? 0 : ``), false)
          )), loc);
          if (dynamicSlots.length) {
            slots = createCallExpression2(context.helper(CREATE_SLOTS2), [slots, createArrayExpression2(dynamicSlots)]);
          }
          return {
            slots,
            hasDynamicSlots
        ...
        function buildDynamicSlot2(name, fn) {
          return createObjectExpression2([createObjectProperty2(`name`, name), createObjectProperty2(`fn`, fn)]);
        }
        ...
        function isNonWhitespaceContent2(node) {
          if (node.type !== 2 && node.type !== 12)
            return true;
          return node.type === 2 ? !!node.content.trim() : isNonWhitespaceContent2(node.content);
        }
        const directiveImportMap2 = /* @__PURE__ */ new WeakMap();
        const transformElement2 = (node, context) => {
          return function postTransformElement() {
            node = context.currentNode;
            if (!(node.type === 1 && (node.tagType === 0 || node.tagType === 1))) {
              return;
            ...
            let vnodeTag = isComponent3 ? resolveComponentType2(node, context) : `"${tag}"`;
            const isDynamicComponent = shared_esm_bundler_isObject(vnodeTag) && vnodeTag.callee === RESOLVE_DYNAMIC_COMPONENT2;
            let vnodeProps;
            let vnodeChildren;
            let vnodePatchFlag;
            let patchFlag = 0;
            ...
            let shouldUseBlock = (
              // dynamic component may resolve to plain elements
              isDynamicComponent || vnodeTag === TELEPORT2 || vnodeTag === SUSPENSE2 || !isComponent3 && // <svg> and <foreignObject> must be forced into blocks so that block
              // updates inside get proper isSVG flag at runtime. (#639, #643)
              // This is technically web-specific, but splitting the logic out of core
              // leads to too much unnecessary complexity.
              (tag === "svg" || tag === "foreignObject")
            ...
            if (props.length > 0) {
              const propsBuildResult = buildProps2(node, context, void 0, isComponent3, isDynamicComponent);
              vnodeProps = propsBuildResult.props;
              patchFlag = propsBuildResult.patchFlag;
              dynamicPropNames = propsBuildResult.dynamicPropNames;
              const directives = propsBuildResult.directives;
            ...
            if (node.children.length > 0) {
              ...
              vnodeTag !== TELEPORT2 && // explained above.
              vnodeTag !== KEEP_ALIVE2;
              if (shouldBuildAsSlots) {
                const {
                  slots,
                  hasDynamicSlots
                } = buildSlots2(node, context);
                vnodeChildren = slots;
                if (hasDynamicSlots) {
                  patchFlag |= 1024;
                }
              } else if (node.children.length === 1 && vnodeTag !== TELEPORT2) {
                const child = node.children[0];
                const type = child.type;
                const hasDynamicTextChild = type === 5 || type === 8;
            ...
            node.codegenNode = createVNodeCall2(
              context,
              vnodeTag,
              vnodeProps,
              vnodeChildren,
        ...
        function resolveComponentType2(node, context, ssr = false) {
          let {
            tag
          } = node;
          const isExplicitDynamic = isComponentTag2(tag);
          const isProp = findProp2(node, "is");
          if (isProp) {
            if (isExplicitDynamic || isCompatEnabled2(
              "COMPILER_IS_ON_ELEMENT",
              context
            )) {
              const exp = isProp.type === 6 ? isProp.value && createSimpleExpression2(isProp.value.content, true) : isProp.exp;
              if (exp) {
                return createCallExpression2(context.helper(RESOLVE_DYNAMIC_COMPONENT2), [exp]);
              }
            } else if (isProp.type === 6 && isProp.value.content.startsWith("vue:")) {
              tag = isProp.value.content.slice(4);
            }
          }
          const isDir = !isExplicitDynamic && findDir2(node, "is");
          if (isDir && isDir.exp) {
            return createCallExpression2(context.helper(RESOLVE_DYNAMIC_COMPONENT2), [isDir.exp]);
          }
          const builtIn = isCoreComponent2(tag) || context.isBuiltInComponent(tag);
          if (builtIn) {
            if (!ssr)
              context.helper(builtIn);
            return builtIn;
          ...
          context.components.add(tag);
          return toValidAssetId2(tag, `component`);
        }
        function buildProps2(node, context, props = node.props, isComponent3, isDynamicComponent, ssr = false) {
          const {
            tag,
            loc: elementLoc,
            children
          ...
          for (let i = 0; i < props.length; i++) {
            ...
            if (prop.type === 6) {
              ...
              if (name === "is" && (isComponentTag2(tag) || value && value.content.startsWith("vue:") || isCompatEnabled2(
                "COMPILER_IS_ON_ELEMENT",
                context
              ))) {
                continue;
              ...
              if (name === "is" || isVBind && isStaticArgOf2(arg, "is") && (isComponentTag2(tag) || isCompatEnabled2(
                "COMPILER_IS_ON_ELEMENT",
                context
              ))) {
                continue;
          ...
          if (!context.inSSR && propsExpression) {
            switch (propsExpression.type) {
              ...
              case 14:
                break;
              default:
                propsExpression = createCallExpression2(context.helper(NORMALIZE_PROPS2), [createCallExpression2(context.helper(GUARD_REACTIVE_PROPS2), [propsExpression])]);
                break;
            }
          }
          return {
        ...
        const transformSlotOutlet2 = (node, context) => {
          if (isSlotOutlet2(node)) {
            const {
              children,
              loc
            } = node;
            const {
              slotName,
              slotProps
            } = processSlotOutlet2(node, context);
            ...
            slotArgs.splice(expectedLen);
            node.codegenNode = createCallExpression2(context.helper(RENDER_SLOT2), slotArgs, loc);
          }
        };
        function processSlotOutlet2(node, context) {
          let slotName = `"default"`;
          let slotProps = void 0;
          const nonNameProps = [];
          for (let i = 0; i < node.props.length; i++) {
            ...
            if (p2.type === 6) {
              if (p2.value) {
                if (p2.name === "name") {
                  ...
                  p2.name = compiler_core_esm_bundler_camelize(p2.name);
                  nonNameProps.push(p2);
                }
              }
            } else {
              if (p2.name === "bind" && isStaticArgOf2(p2.arg, "name")) {
                if (p2.exp)
                  slotName = p2.exp;
              } else {
                if (p2.name === "bind" && p2.arg && isStaticExp2(p2.arg)) {
                  p2.arg.content = compiler_core_esm_bundler_camelize(p2.arg.content);
                }
                nonNameProps.push(p2);
              }
            }
          ...
          if (nonNameProps.length > 0) {
            const {
              props,
              directives
            } = buildProps2(node, context, nonNameProps, false, false);
            slotProps = props;
            if (directives.length) {
              context.onError(createCompilerError2(
                36,
        ...
        const fnExpRE2 = /^\s*([\w$_]+|(async\s*)?\([^)]*?\))\s*=>|^\s*(async\s+)?function(?:\s+[\w$]+)?\s*\(/;
        const transformOn3 = (dir, node, context, augmentor) => {
          const {
            loc,
            modifiers,
            arg
          ...
          if (arg.type === 4) {
            if (arg.isStatic) {
              ...
              eventName = createSimpleExpression2(toHandlerKey2(camelize2(rawName)), true, arg.loc);
            } else {
              eventName = createCompoundExpression2([`${context.helperString(TO_HANDLER_KEY2)}(`, arg, `)`]);
            }
          } else {
            eventName = arg;
          ...
          let shouldCache = context.cacheHandlers && !exp && !context.inVOnce;
          if (exp) {
            const isMemberExp = isMemberExpression2(exp.content);
            const isInlineStatement = !(isMemberExp || fnExpRE2.test(exp.content));
            const hasMultipleStatements = exp.content.includes(`;`);
            if (false) {
            }
            if (isInlineStatement || shouldCache && isMemberExp) {
              exp = createCompoundExpression2([`${isInlineStatement ? `$event` : `${``}(...args)`} => ${hasMultipleStatements ? `{` : `(`}`, exp, hasMultipleStatements ? `}` : `)`]);
            }
          }
          let ret = {
            props: [createObjectProperty2(eventName, exp || createSimpleExpression2(`() => {}`, false, loc))]
          };
          if (augmentor) {
            ret = augmentor(ret);
          }
        ...
        const transformBind2 = (dir, _node, context) => {
          const {
            exp,
            modifiers,
            loc
        ...
        const injectPrefix2 = (arg, prefix) => {
          if (arg.type === 4) {
            if (arg.isStatic) {
              arg.content = prefix + arg.content;
            } else {
        ...
        const transformText2 = (node, context) => {
          if (node.type === 0 || node.type === 1 || node.type === 11 || node.type === 10) {
            return () => {
              const children = node.children;
              let currentContainer = void 0;
              ...
              for (let i = 0; i < children.length; i++) {
                ...
                if (isText2(child)) {
                  ...
                  for (let j = i + 1; j < children.length; j++) {
                    ...
                    if (isText2(next)) {
                      if (!currentContainer) {
                        currentContainer = children[i] = createCompoundExpression2([child], child.loc);
                      }
                      currentContainer.children.push(` + `, next);
                      children.splice(j, 1);
                      j--;
        ...
        const transformOnce2 = (node, context) => {
          if (node.type === 1 && findDir2(node, "once", true)) {
            if (seen2.has(node) || context.inVOnce) {
              return;
            }
            seen2.add(node);
            context.inVOnce = true;
        ...
        const transformModel3 = (dir, node, context) => {
          const {
            exp,
            arg
          } = dir;
          ...
          const maybeRef = false;
          if (!expString.trim() || !isMemberExpression2(expString) && !maybeRef) {
            context.onError(createCompilerError2(
              42,
              exp.loc
            ));
          ...
          const eventArg = context.isTS ? `($event: any)` : `$event`;
          {
            assignmentExp = createCompoundExpression2([`${eventArg} => ((`, exp, `) = $event)`]);
          }
          const props = [
            // modelValue: foo
          ...
          if (dir.modifiers.length && node.tagType === 1) {
            ...
            props.push(createObjectProperty2(modifiersKey, createSimpleExpression2(
              `{ ${modifiers} }`,
              false,
              dir.loc,
              2
        ...
        const validDivisionCharRE2 = /[\w).+\-_$\]]/;
        const transformFilter2 = (node, context) => {
          if (!isCompatEnabled2(
            "COMPILER_FILTER",
            context
          )) {
          ...
          if (node.type === 5) {
            rewriteFilter2(node.content, context);
          }
          if (node.type === 1) {
            node.props.forEach((prop) => {
              if (prop.type === 7 && prop.name !== "for" && prop.exp) {
                rewriteFilter2(prop.exp, context);
              }
            });
          }
        };
        function rewriteFilter2(node, context) {
          if (node.type === 4) {
            parseFilter2(node, context);
          } else {
            for (let i = 0; i < node.children.length; i++) {
              const child = node.children[i];
              if (typeof child !== "object")
                continue;
              if (child.type === 4) {
                parseFilter2(child, context);
              } else if (child.type === 8) {
                rewriteFilter2(node, context);
              } else if (child.type === 5) {
                rewriteFilter2(child.content, context);
              }
            }
          }
        }
        function parseFilter2(node, context) {
          const exp = node.content;
          let inSingle = false;
          let inDouble = false;
          let inTemplateString = false;
          ...
          if (filters.length) {
            for (i = 0; i < filters.length; i++) {
              expression = wrapFilter2(expression, filters[i], context);
            }
            node.content = expression;
          }
        }
        function wrapFilter2(exp, filter, context) {
          context.helper(RESOLVE_FILTER2);
          const i = filter.indexOf("(");
          if (i < 0) {
            context.filters.add(filter);
            return `${toValidAssetId2(filter, "filter")}(${exp})`;
          } else {
            const name = filter.slice(0, i);
            const args = filter.slice(i + 1);
            context.filters.add(name);
        ...
        const seen$12 = /* @__PURE__ */ new WeakSet();
        const transformMemo2 = (node, context) => {
          if (node.type === 1) {
            const dir = findDir2(node, "memo");
            if (!dir || seen$12.has(node)) {
              return;
            }
            seen$12.add(node);
            return () => {
              ...
              if (codegenNode && codegenNode.type === 13) {
                ...
                node.codegenNode = createCallExpression2(context.helper(WITH_MEMO2), [dir.exp, createFunctionExpression2(void 0, codegenNode), `_cache`, String(context.cached++)]);
              }
            };
          }
        };
        function getBaseTransformPreset2(prefixIdentifiers) {
          return [[transformOnce2, transformIf2, transformMemo2, transformFor2, ...[transformFilter2], ...false ? 0 : [], transformSlotOutlet2, transformElement2, trackSlotScopes2, transformText2], {
            on: transformOn3,
            bind: transformBind2,
            model: transformModel3
          }];
        }
        function baseCompile2(template, options = {}) {
          ...
          const [nodeTransforms, directiveTransforms] = getBaseTransformPreset2();
          transform2(ast, shared_esm_bundler_extend({}, options, {
            prefixIdentifiers,
            nodeTransforms: [
              ...nodeTransforms,
              ...options.nodeTransforms || []
          ...
          return generate2(ast, shared_esm_bundler_extend({}, options, {
            prefixIdentifiers
          }));
        }
        const noopDirectiveTransform2 = () => ({
          props: []
        });
        ;
        const V_MODEL_RADIO2 = Symbol(false ? 0 : ``);
        const V_MODEL_CHECKBOX2 = Symbol(false ? 0 : ``);
        const V_MODEL_TEXT2 = Symbol(false ? 0 : ``);
        const V_MODEL_SELECT2 = Symbol(false ? 0 : ``);
        const V_MODEL_DYNAMIC2 = Symbol(false ? 0 : ``);
        const V_ON_WITH_MODIFIERS2 = Symbol(false ? 0 : ``);
        const V_ON_WITH_KEYS2 = Symbol(false ? 0 : ``);
        const V_SHOW2 = Symbol(false ? 0 : ``);
        const compiler_dom_esm_bundler_TRANSITION = Symbol(false ? 0 : ``);
        const TRANSITION_GROUP2 = Symbol(false ? 0 : ``);
        registerRuntimeHelpers2({
        ...
        let decoder2;
        function decodeHtmlBrowser2(raw, asAttr = false) {
          if (!decoder2) {
        ...
        const isRawTextContainer2 = shared_esm_bundler_makeMap("style,iframe,script,noscript", true);
        const parserOptions2 = {
          isVoidTag: isVoidTag2,
          isNativeTag: (tag) => shared_esm_bundler_isHTMLTag(tag) || shared_esm_bundler_isSVGTag(tag),
          isPreTag: (tag) => tag === "pre",
          decodeEntities: decodeHtmlBrowser2,
          isBuiltInComponent: (tag) => {
            if (isBuiltInType2(tag, `Transition`)) {
              return compiler_dom_esm_bundler_TRANSITION;
            } else if (isBuiltInType2(tag, `TransitionGroup`)) {
            ...
            node.props.forEach((p2, i) => {
              if (p2.type === 6 && p2.name === "style" && p2.value) {
                node.props[i] = {
                  type: 7,
                  name: `bind`,
                  arg: createSimpleExpression2(`style`, true, p2.loc),
                  exp: parseInlineCSS2(p2.value.content, p2.loc),
                  modifiers: [],
                  loc: p2.loc
                };
              }
        ...
        const parseInlineCSS2 = (cssText, loc) => {
          const normalized = parseStringStyle2(cssText);
          return createSimpleExpression2(
            JSON.stringify(normalized),
            false,
            loc,
            3
        ...
        function createDOMCompilerError2(code, loc) {
          return createCompilerError2(code, loc, false ? 0 : void 0);
        }
        const DOMErrorMessages2 = {
          [
            50
        ...
        const transformVHtml2 = (dir, node, context) => {
          const {
            exp,
            loc
          } = dir;
          if (!exp) {
            context.onError(createDOMCompilerError2(
              50,
              loc
            ));
          }
          ...
          return {
            props: [createObjectProperty2(createSimpleExpression2(`innerHTML`, true, loc), exp || createSimpleExpression2("", true))]
          };
        };
        const transformVText2 = (dir, node, context) => {
          const {
            exp,
            loc
          } = dir;
          ...
          return {
            props: [createObjectProperty2(createSimpleExpression2(`textContent`, true), exp ? getConstantType2(exp, context) > 0 ? exp : createCallExpression2(context.helperString(TO_DISPLAY_STRING2), [exp], loc) : createSimpleExpression2("", true))]
          };
        };
        const compiler_dom_esm_bundler_transformModel = (dir, node, context) => {
          const baseResult = transformModel3(dir, node, context);
          if (!baseResult.props.length || node.tagType === 1) {
            return baseResult;
          }
          if (dir.arg) {
          ...
          function checkDuplicatedValue() {
            const value = findProp2(node, "value");
            if (value) {
              context.onError(createDOMCompilerError2(
                57,
                value.loc
          ...
          if (tag === "input" || tag === "textarea" || tag === "select" || isCustomElement) {
            ...
            let isInvalidType = false;
            if (tag === "input" || isCustomElement) {
              const type = findProp2(node, `type`);
              if (type) {
                if (type.type === 7) {
              ...
              } else if (hasDynamicKeyVBind2(node)) {
                directiveToUse = V_MODEL_DYNAMIC2;
              } else {
              }
            } else if (tag === "select") {
        ...
        const isEventOptionModifier2 = shared_esm_bundler_makeMap(`passive,once,capture`);
        const isNonKeyModifier2 = shared_esm_bundler_makeMap(
          // event propagation management
          `stop,prevent,self,ctrl,shift,alt,meta,exact,middle`
        );
        const maybeKeyModifier2 = shared_esm_bundler_makeMap("left,right");
        const isKeyboardEvent2 = shared_esm_bundler_makeMap(`onkeyup,onkeydown,onkeypress`, true);
        const resolveModifiers2 = (key, modifiers, context, loc) => {
          const keyModifiers = [];
          const nonKeyModifiers = [];
          const eventOptionModifiers = [];
          for (let i = 0; i < modifiers.length; i++) {
            const modifier = modifiers[i];
            if (modifier === "native" && checkCompatEnabled2(
              "COMPILER_V_ON_NATIVE",
              context,
              loc
            )) {
        ...
        const transformClick2 = (key, event) => {
          const isStaticClick = isStaticExp2(key) && key.content.toLowerCase() === "onclick";
          return isStaticClick ? createSimpleExpression2(event, true) : key.type !== 4 ? createCompoundExpression2([`(`, key, `) === "onClick" ? "${event}" : (`, key, `)`]) : key;
        };
        const compiler_dom_esm_bundler_transformOn = (dir, node, context) => {
          return transformOn3(dir, node, context, (baseResult) => {
            const {
              modifiers
            } = dir;
            if (!modifiers.length)
            ...
            const {
              ...
              nonKeyModifiers,
              eventOptionModifiers
            } = resolveModifiers2(key, modifiers, context, dir.loc);
            if (nonKeyModifiers.includes("right")) {
            ...
            if (nonKeyModifiers.length) {
              handlerExp = createCallExpression2(context.helper(V_ON_WITH_MODIFIERS2), [handlerExp, JSON.stringify(nonKeyModifiers)]);
            }
            if (keyModifiers.length && // if event name is dynamic, always wrap with keys guard
            (!isStaticExp2(key) || isKeyboardEvent2(key.content))) {
              handlerExp = createCallExpression2(context.helper(V_ON_WITH_KEYS2), [handlerExp, JSON.stringify(keyModifiers)]);
            }
            if (eventOptionModifiers.length) {
              const modifierPostfix = eventOptionModifiers.map(shared_esm_bundler_capitalize).join("");
              key = isStaticExp2(key) ? createSimpleExpression2(`${key.content}${modifierPostfix}`, true) : createCompoundExpression2([`(`, key, `) + "${modifierPostfix}"`]);
            }
            return {
              props: [createObjectProperty2(key, handlerExp)]
            };
          });
        };
        const transformShow2 = (dir, node, context) => {
          const {
            exp,
            loc
          } = dir;
        ...
        const transformTransition2 = (node, context) => {
          if (node.type === 1 && node.tagType === 1) {
            const component = context.isBuiltInComponent(node.tag);
        ...
        const DOMNodeTransforms2 = [transformStyle2, ...false ? 0 : []];
        const DOMDirectiveTransforms2 = {
          cloak: noopDirectiveTransform2,
        ...
        function compiler_dom_esm_bundler_compile(template, options = {}) {
          return baseCompile2(template, shared_esm_bundler_extend({}, parserOptions2, options, {
            nodeTransforms: [
              // ignore <script> and <tag>
              // this is not put inside DOMNodeTransforms because that list is used
              // by compiler-ssr to generate vnode fallback branches
            ...
            directiveTransforms: shared_esm_bundler_extend({}, DOMDirectiveTransforms2, options.directiveTransforms || {}),
            transformHoist: null
          }));
        }
        function parse2(template, options = {}) {
          return baseParse(template, extend({}, parserOptions2, options));
        }
        ;
        function initDev() {
          {
...
${codeFrame}` : message);
          ...
          const render2 = new Function("Vue", code)(runtime_dom_esm_bundler_namespaceObject);
          render2._rc = true;
        ...
        ;
        let lastEditorId = 0;
        var EmailEditorvue_type_script_lang_js = {
          name: "EmailEditor",
          props: {
            editorId: String,
            options: Object,
        ...
        ;
        ;
        const __exports__ = (0, exportHelper.Z)(EmailEditorvue_type_script_lang_js, [["render", EmailEditorvue_type_template_id_eb864766_scoped_true_render], ["__scopeId", "data-v-eb864766"]]);
        var EmailEditor = __exports__;
        ;
        const Components = {
          EmailEditor
        };
...
export default require_vue_email_editor_common();
//# sourceMappingURL=vue-email-editor.js.map
